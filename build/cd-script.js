                ...
                function g(n) {
                    if (i)
                        if (r = m(n, i), s) {
                            ...
                            return d && (i = 90 - i), i < t.options.dragAngleThreshold
                    ...
                    s = {
                        ...
                        mount: function () {
                            ...
                            r.slides.length > n.perPage && (i = function (t, n, e) {
                                ...
                                n.pauseOnHover && (a(i, "mouseleave", 1, !0), a(i, "mouseenter", 1, !1)), n.pauseOnFocus && (a(i, "focusout", 2, !0), a(i, "focusin", 2, !1)), r.play && t.on("click", (function () {
                                    s.play(2), s.play(3)
                                }), r.play), r.pause && a([r.pause], "click", 3, !1), t.on("move refresh", (function () {
                                    s.play()
                                })).on("destroy", (function () {
                                    s.pause()
                                }))
                ...
                return {
                    ...
                    mount: function () {
                        i = u.arrows.prev, o = u.arrows.next, i && o || !t.options.arrows || (i = d(!0), o = d(!1), r = !0, function () {
                            ...
                            w(n, i), w(n, o);
                            var e = u.slider;
                            x(n, ("slider" === t.options.arrows && e ? e : a).firstElementChild)
            ...
            LazyLoad: function (t, n, e) {
                ...
                function d(n, e) {
                    ...
                    w(n.parentElement, i), n.onload = function () {
                        ...
                        l(n, i, e, !0)
                    }, C(n, "srcset", z(n, mt) || ""), C(n, "src", z(n, "data-splide-lazy") || "")
                }
...
! function (global, factory) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = factory(require("jquery")) : "function" == typeof define && define.amd ? define(["jquery"], factory) : (global = global || self).Util = factory(global.jQuery)
}(this, (function ($) {
    "use strict";
    ...
    return Util.jQueryDetection(), $.fn.emulateTransitionEnd = transitionEndEmulator, $.event.special[Util.TRANSITION_END] = {
        bindType: "transitionend",
        delegateType: "transitionend",
        handle: function (event) {
            return $(event.target).is(this) ? event.handleObj.handler.apply(this, arguments) : undefined
        }
    }, Util
}));
/*!
 ...
 */
! function (global, factory) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = factory(require("jquery"), require("./util.js")) : "function" == typeof define && define.amd ? define(["jquery", "./util.js"], factory) : (global = global || self).Collapse = factory(global.jQuery, global.Util)
}(this, (function ($, Util) {
    "use strict";
    ...
    var NAME = "collapse",
        ...
        Event = {
            SHOW: "show.nv.collapse",
            SHOWN: "shown.nv.collapse",
            HIDE: "hide.nv.collapse",
            HIDDEN: "hidden.nv.collapse",
            CLICK_DATA_API: "click.nv.collapse.data-api"
        },
        ClassName_SHOW = "show",
        ...
        Collapse = function () {
            ...
            var Constructor, protoProps, staticProps, _proto = Collapse.prototype;
            return _proto.toggle = function () {
                ...
                if (!this._isTransitioning && !$(this._element).hasClass(ClassName_SHOW) && (this._parent && 0 === (actives = [].slice.call(this._parent.querySelectorAll(Selector_ACTIVES)).filter((function (elem) {
                    ...
                    }))).length && (actives = null), !(actives && (activesData = $(actives).not(this._selector).data(DATA_KEY)) && activesData._isTransitioning))) {
                    ...
                    if ($(this._element).trigger(startEvent), !startEvent.isDefaultPrevented()) {
                        ...
                        $(this._element).removeClass(ClassName_COLLAPSE).addClass(ClassName_COLLAPSING), this._element.style[dimension] = 0, this._triggerArray.length && $(this._triggerArray).removeClass(ClassName_COLLAPSED).attr("aria-expanded", !0), this.setTransitioning(!0);
                        ...
                        $(this._element).one(Util.TRANSITION_END, (function () {
                            $(_this._element).removeClass(ClassName_COLLAPSING).addClass(ClassName_COLLAPSE).addClass(ClassName_SHOW), _this._element.style[dimension] = "", _this.setTransitioning(!1), $(_this._element).trigger(Event.SHOWN)
                ...
                if (!this._isTransitioning && $(this._element).hasClass(ClassName_SHOW)) {
                    ...
                    if ($(this._element).trigger(startEvent), !startEvent.isDefaultPrevented()) {
                        var dimension = this._getDimension();
                        this._element.style[dimension] = this._element.getBoundingClientRect()[dimension] + "px", Util.reflow(this._element), $(this._element).addClass(ClassName_COLLAPSING).removeClass(ClassName_COLLAPSE).removeClass(ClassName_SHOW);
                ...
                return (config = _objectSpread2({}, Default, {}, config)).toggle = Boolean(config.toggle), Util.typeCheckConfig(NAME, config, DefaultType), config
                ...
                Util.isElement(this._config.parent) ? (parent = this._config.parent, "undefined" != typeof this._config.parent.jquery && (parent = this._config.parent[0])) : parent = document.querySelector(this._config.parent);
                ...
                return this.each((function () {
                    var $this = $(this),
                        ...
                        _config = _objectSpread2({}, Default, {}, $this.data(), {}, "object" == typeof config && config ? config : {});
            ...
            }, Constructor = Collapse, staticProps = [{
                key: "VERSION",
                get: function () {
                    return "4.4.1"
                }
            ...
            }], (protoProps = null) && _defineProperties(Constructor.prototype, protoProps), staticProps && _defineProperties(Constructor, staticProps), Collapse
        }();
    return $(document).on(Event.CLICK_DATA_API, Selector_DATA_TOGGLE, (function (event) {
 ...
 */
! function (global, factory) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = factory(require("jquery"), require("./util.js")) : "function" == typeof define && define.amd ? define(["jquery", "./util.js"], factory) : (global = global || self).Modal = factory(global.jQuery, global.Util)
}(this, (function ($, Util) {
    "use strict";
    ...
    var NAME = "modal",
        ...
        ClassName_SCROLLABLE = "nv-modal-dialog-scrollable",
        ClassName_SCROLLBAR_MEASURER = "nv-modal-scrollbar-measure",
        ClassName_BACKDROP = "nv-modal-backdrop",
        ClassName_OPEN = "nv-modal-open",
        ClassName_FADE = "fade",
        ClassName_SHOW = "show",
        ClassName_STATIC = "nv-modal-static",
        Selector_DIALOG = ".nv-modal-dialog",
        Selector_MODAL_BODY = ".nv-modal-body",
        ...
        Modal = function () {
            function Modal(element, config) {
                this._config = this._getConfig(config), this._element = element, this._dialog = element.querySelector(Selector_DIALOG), this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._scrollbarWidth = 0
            }
            ...
            return _proto.toggle = function (relatedTarget) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    $(this._element).hasClass(ClassName_FADE) && (this._isTransitioning = !0);
                    var showEvent = $.Event(Event.SHOW, {
                        relatedTarget: relatedTarget
                    });
                    $(this._element).trigger(showEvent), this._isShown || showEvent.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), $(this._element).on(Event.CLICK_DISMISS, Selector_DATA_DISMISS, (function (event) {
                ...
                if (event && event.preventDefault(), this._isShown && !this._isTransitioning) {
                    ...
                    if ($(this._element).trigger(hideEvent), this._isShown && !hideEvent.isDefaultPrevented()) {
                        this._isShown = !1;
                        var transition = $(this._element).hasClass(ClassName_FADE);
                        if (transition && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), $(document).off(Event.FOCUSIN), $(this._element).removeClass(ClassName_SHOW), $(this._element).off(Event.CLICK_DISMISS), $(this._dialog).off(Event.MOUSEDOWN_DISMISS), transition) {
                            var transitionDuration = Util.getTransitionDurationFromElement(this._element);
                ...
                })), $(document).off(Event.FOCUSIN), $.removeData(this._element, "nv.modal"), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
            }, _proto.handleUpdate = function () {
                this._adjustDialog()
            }, _proto._getConfig = function (config) {
                return config = _objectSpread2({}, Default, {}, config), Util.typeCheckConfig(NAME, config, DefaultType), config
                ...
                if ("static" === this._config.backdrop) {
                    ...
                    this._element.classList.add(ClassName_STATIC);
                    var modalTransitionDuration = Util.getTransitionDurationFromElement(this._element);
                    $(this._element).one(Util.TRANSITION_END, (function () {
                        _this3._element.classList.remove(ClassName_STATIC)
                    })).emulateTransitionEnd(modalTransitionDuration), this._element.focus()
                } else this.hide()
            }, _proto._showElement = function (relatedTarget) {
                var _this4 = this,
                    transition = $(this._element).hasClass(ClassName_FADE),
                    modalBody = this._dialog ? this._dialog.querySelector(Selector_MODAL_BODY) : null;
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), $(this._dialog).hasClass(ClassName_SCROLLABLE) && modalBody ? modalBody.scrollTop = 0 : this._element.scrollTop = 0, transition && Util.reflow(this._element), $(this._element).addClass(ClassName_SHOW), this._config.focus && this._enforceFocus();
                ...
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop((function () {
                    $(document.body).removeClass(ClassName_OPEN), _this8._resetAdjustments(), _this8._resetScrollbar(), $(_this8._element).trigger(Event.HIDDEN)
                }))
                ...
                var _this9 = this,
                    animate = $(this._element).hasClass(ClassName_FADE) ? ClassName_FADE : "";
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = ClassName_BACKDROP, $(this._backdrop).appendTo(document.body), $(this._element).on(Event.CLICK_DISMISS, (function (event) {
                        ...
                        })), animate && Util.reflow(this._backdrop), $(this._backdrop).addClass(ClassName_SHOW), !callback) return;
                    if (!animate) return void callback();
                    var backdropTransitionDuration = Util.getTransitionDurationFromElement(this._backdrop);
                    $(this._backdrop).one(Util.TRANSITION_END, callback).emulateTransitionEnd(backdropTransitionDuration)
                } else if (!this._isShown && this._backdrop) {
                    $(this._backdrop).removeClass(ClassName_SHOW);
                    var callbackRemove = function () {
                        _this9._removeBackdrop(), callback && callback()
                    };
                    if ($(this._element).hasClass(ClassName_FADE)) {
                ...
                if (this._isBodyOverflowing) {
                    var fixedContent = [].slice.call(document.querySelectorAll(Selector_FIXED_CONTENT)),
                        stickyContent = [].slice.call(document.querySelectorAll(Selector_STICKY_CONTENT));
                ...
                $(document.body).addClass(ClassName_OPEN)
                ...
                return this.each((function () {
                    var data = $(this).data("nv.modal"),
                        _config = _objectSpread2({}, Default, {}, $(this).data(), {}, "object" == typeof config && config ? config : {});
                    if (data || (data = new Modal(this, _config), $(this).data("nv.modal", data)), "string" == typeof config) {
                        if ("undefined" == typeof data[config]) throw new TypeError('No method named "' + config + '"');
                        data[config](relatedTarget)
                    } else _config.show && data.show(relatedTarget)
                }))
            }, Constructor = Modal, staticProps = [{
                key: "VERSION",
                get: function () {
                    return "4.4.1"
                }
            ...
            }], (protoProps = null) && _defineProperties(Constructor.prototype, protoProps), staticProps && _defineProperties(Constructor, staticProps), Modal
        }();
    return $(document).on(Event.CLICK_DATA_API, Selector_DATA_TOGGLE, (function (event) {
        var target, _this11 = this,
            selector = Util.getSelectorFromElement(this);
        selector && (target = document.querySelector(selector));
        var config = $(target).data("nv.modal") ? "toggle" : _objectSpread2({}, $(target).data(), {}, $(this).data());
...
jQuery(document).ready((function () {
    $(".cd-verticalBar__hamburger").click((function () {
        $(".cd-verticalBar").toggleClass("active"), $(this).toggleClass("active")
    }))
}));