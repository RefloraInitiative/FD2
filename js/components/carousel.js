...
var myCarousel = (function() {
    ...
    function init(set) {
        ...
        ctrls.innerHTML = '<li>' +
            '<button type="button" class="btn-prev"><span class="arrow-left"></span><span class="visually-hidden">Previous slide</span></button>' +
            '</li>' +
            '<li>' +
            '<button type="button" class="btn-next"><span class="arrow-right"></span><span class="visually-hidden">Next slide</span></button>' +
            '</li>';
        ...
        if (settings.slidenav || settings.animate) {
            ...
            if (settings.animate) {
                ...
                if (settings.startAnimated) {
                    ...
                    li.innerHTML = '<button data-action="start"><span class="visuall-yhidden">Start Animation </span>▶</button>';
                }
