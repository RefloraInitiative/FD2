...
(function(global, factory) {
    ...
    var ClassName = {
        SCROLLABLE: 'nv-modal-dialog-scrollable',
        SCROLLBAR_MEASURER: 'nv-modal-scrollbar-measure',
        BACKDROP: 'nv-modal-backdrop',
        OPEN: 'nv-modal-open',
        FADE: 'fade',
        SHOW: 'show',
        STATIC: 'nv-modal-static'
    };
    var Selector = {
        DIALOG: '.nv-modal-dialog',
        MODAL_BODY: '.nv-modal-body',
